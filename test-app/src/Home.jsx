...
const Home = () => {
  ...
  const handleClick = async () => {
    try {
      window.location.replace = `https://api.instagram.com/oauth/authorize/?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&scope=user_profile,user_media&response_type=code`;
